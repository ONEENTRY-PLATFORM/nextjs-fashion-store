...
Hero titles use a **special responsive typography rule**.
...
**Weight**  
700 *(allowed only in Hero sections)*
...
The default system **H1 remains:**

- **48px / 56px**
- **Weight 600**

Hero H1 is **larger and bolder** to create a marketing impact.
...
The subtitle should remain **short and readable**.

---

## Hero CTA Button

Hero CTA follows the **Primary Button system** but includes additional marketing styling.
...
Content always sits near the **bottom of the hero image**.
