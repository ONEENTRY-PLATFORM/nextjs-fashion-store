  ...
  women: {
    clothing: [
      ...
      },
      {
        ...
        items: ['Fitness & Yoga', 'Knitwear', 'Natural & Eco Leather', 'Office Wear', 'Home Collection'],
      },
    ],
    shoes: [
      {
...
const I = {
  womenFashion:
    'https://images.unsplash.com/photo-1599662875272-64de8289f6d8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600',
  menFashion:
    'https://images.unsplash.com/photo-1632934330201-a641618914d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600',
  womenHeels:
    'https://images.unsplash.com/photo-1621996659490-3275b4d0d951?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600',
  menSneakers:
    'https://images.unsplash.com/photo-1618153478389-b2ed8de18ed3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600',
  accessories:
    'https://images.unsplash.com/photo-1724896728499-2e7ecef652a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600',
...
const q = (base: string, key: string, value: string) => `${base}?${key}=${encodeURIComponent(value)}`;
...
export const SHOP_CATEGORIES: ShopCategory[] = [
  // ── Outerwear ──
  {
    ...
    label: 'Coats',
    chip: 'Outerwear',
    image: I.womenFashion,
    href: q('/women/clothing', 'clothingType', 'Outerwear'),
  },
  {
    id: 'jackets',
    label: 'Jackets',
    chip: 'Outerwear',
    image: I.menFashion,
    href: q('/men/clothing', 'clothingType', 'Outerwear'),
  },
  {
    id: 'blazers-w',
    label: 'Blazers',
    chip: 'Outerwear',
    image: I.womenHeels,
    href: q('/women/clothing', 'clothingType', 'Blazers'),
  },
  {
    id: 'blazers-m',
    label: 'Suits & Blazers',
    chip: 'Outerwear',
    image: I.menSneakers,
    href: q('/men/clothing', 'clothingType', 'Blazers'),
  },
  {
    id: 'suits',
    label: 'Suits',
    chip: 'Outerwear',
    image: I.accessories,
    href: q('/men/clothing', 'clothingType', 'Suits'),
  },
  ...
  // ── Tops ──
  {
    ...
    chip: 'Tops',
    image: I.womenFashion,
    href: q('/women/clothing', 'clothingType', 'Shirts'),
  },
  {
    id: 'shirts-m',
    label: 'Shirts (Men)',
    chip: 'Tops',
    image: I.menFashion,
    href: q('/men/clothing', 'clothingType', 'Shirts'),
  },
  {
    id: 'tshirts',
    label: 'T-Shirts',
    chip: 'Tops',
    image: I.womenHeels,
    href: q('/men/clothing', 'clothingType', 'T-Shirts / Polo Shirts'),
  },
  {
    id: 'sweaters',
    label: 'Sweaters',
    chip: 'Tops',
    image: I.menSneakers,
    href: q('/women/clothing', 'clothingType', 'Sweaters / Turtlenecks / Jumpers'),
  },
  {
    id: 'hoodies-w',
    label: 'Hoodies',
    chip: 'Tops',
    image: I.accessories,
    href: q('/women/clothing', 'clothingType', 'Hoodies / Sweatshirts'),
  },
  {
    id: 'tank',
    label: 'Tank Tops',
    chip: 'Tops',
    image: I.bags,
    href: q('/women/clothing', 'clothingType', 'Tank Tops'),
  },
  ...
  // ── Bottoms ──
  {
    ...
    chip: 'Bottoms',
    image: I.womenFashion,
    href: q('/women/clothing', 'clothingType', 'Jeans'),
  },
  {
    id: 'jeans-m',
    label: 'Jeans (Men)',
    chip: 'Bottoms',
    image: I.menFashion,
    href: q('/men/clothing', 'clothingType', 'Jeans'),
  },
  {
    id: 'skirts',
    label: 'Skirts',
    chip: 'Bottoms',
    image: I.womenHeels,
    href: q('/women/clothing', 'clothingType', 'Skirts'),
  },
  {
    id: 'trousers',
    label: 'Trousers',
    chip: 'Bottoms',
    image: I.menSneakers,
    href: q('/men/clothing', 'clothingType', 'Trousers'),
  },
  {
    id: 'dresses',
    label: 'Dresses',
    chip: 'Bottoms',
    image: I.accessories,
    href: q('/women/clothing', 'clothingType', 'Dresses'),
  },
  ...
  // ── Sports ──
  {
    ...
    chip: 'Sports',
    image: I.womenFashion,
    href: q('/men/clothing', 'clothingType', 'Sportswear'),
  },
  {
    id: 'hoodies-m',
    label: 'Hoodies (Men)',
    chip: 'Sports',
    image: I.menFashion,
    href: q('/men/clothing', 'clothingType', 'Hoodies / Sweatshirts'),
  },
  {
    id: 'pants-w',
    label: 'Pants',
    chip: 'Sports',
    image: I.womenHeels,
    href: q('/women/clothing', 'clothingType', 'Pants'),
  },
  {
    id: 'sweaters-m',
    label: 'Knitwear',
    chip: 'Sports',
    image: I.menSneakers,
    href: q('/men/clothing', 'clothingType', 'Sweaters / Turtlenecks / Jumpers'),
  },
