...
export function ReviewsSkeleton() {
  return (
    <div className="px-4 lg:px-8 py-12 max-w-screen-xl mx-auto border-t border-[#e5e7eb]">
      <div className="h-5 w-48 mb-8 bg-accent animate-pulse rounded-sm" />

      <div className="flex flex-col lg:flex-row gap-12">
        <div className="lg:w-64 flex-shrink-0">
          <div className="flex flex-col items-center mb-6">
            <div className="h-14 w-20 bg-accent animate-pulse rounded mb-2" />
          ...
          <div className="space-y-2">
            {[5, 4, 3, 2, 1].map((stars) => (
              <div key={stars} className="flex items-center gap-2">
                ...
                <div className="h-1.5 w-2 bg-accent animate-pulse rounded" />
                <div className="flex-1 h-1.5 bg-accent animate-pulse" />
                <span className="text-xs text-gray-300 w-4">·</span>
              </div>
            ))}
          </div>
          <div className="h-11 w-full mt-6 bg-accent animate-pulse rounded-sm" />
        </div>
            ...
            <div key={i} className="py-6 border-b border-gray-100 space-y-3">
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2 flex-1">
                  <div className="h-3 w-28 bg-accent animate-pulse rounded" />
                  <div className="h-4 w-3/5 bg-accent animate-pulse rounded" />
                </div>
                <div className="h-3 w-20 bg-accent animate-pulse rounded" />
              </div>
              <div className="space-y-1.5">
                <div className="h-3 w-full bg-accent animate-pulse rounded" />
                <div className="h-3 w-11/12 bg-accent animate-pulse rounded" />
