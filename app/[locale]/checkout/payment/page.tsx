...
/** Title/description/keywords/canonical come from the OE `payment` page when an editor filled them. */
export async function generateMetadata(): Promise<Metadata> {
  return withCmsSeo('payment', SEO.checkoutPayment);
}

export default async function Page() {
  // The checkout forms travel to this step for their attribute labels: when OE rejects an order it names the offending field by its raw marker, and `explainOrderError` swaps in the label the shopper actually saw.
