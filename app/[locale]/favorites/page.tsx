...
/** Title/description/keywords/canonical come from the OE `favorites` page when an editor filled them. */
...
export default async function Page() {
  const [recommended, trending, pageBlocks] = await Promise.all([
    // Bigger server-side slice because the client-side gender scoping (Recommended/Trending are filtered by the shopper's preferred gender) will drop up to half the items on a mixed-gender tenant.
